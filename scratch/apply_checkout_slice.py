...
# Slices
# start_pay_idx = 3475, end_pay_idx = 3596
# start_click_idx = 8038, end_click_idx = 8046

new_lines = lines[:3475] + [replace_pay_fn] + lines[3596:8038] + [replace_click_handler] + lines[8046:]

with open("test_script.jsx", "w", encoding="utf-8") as f:
    f.writelines(new_lines)

print("test_script.jsx sliced and replaced successfully!")
